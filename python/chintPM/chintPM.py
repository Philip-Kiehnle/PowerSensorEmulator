...
from typing import TypedDict, TypeVar, Optional, Any, Final
...
class ChintDxsuDevice:
    ...
    def __init__(self, entry, scan_interval) -> None:
    ...
    async def read_values(self, client, unit_id):
        ...
        print("read modbus value groups")
...
class ChintUpdateCoordinator():
    ...
    # async def _async_update_data(self):
        try:
            ...
            print("Could not update values {err}")
...
async def async_setup_entry(entry: ConfigEntry):
    ...
    update_coordinators.append(
        await _create_update_coordinator(device, entry, UPDATE_INTERVAL)
    )

    #await hass.config_entries.async_forward_entry_setups(entry, PLATFORMS)
    # await async_setup_services(hass, entry, device)
    #return True
    return update_coordinators[0]
